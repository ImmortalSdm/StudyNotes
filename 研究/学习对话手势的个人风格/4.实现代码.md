...
```
python -m audio_to_multiple_pose_gan.train --gans 1 --name test_run --arch_g audio_to_pose_gans --arch_d D_patchgan --speaker conan --output_path ../tmpttt --train_csv ../train_conan.csv --epochs 200
```
