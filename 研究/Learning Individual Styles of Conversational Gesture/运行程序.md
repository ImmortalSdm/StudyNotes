...
```
```
python -m audio_to_multiple_pose_gan.train --gans 1 --name oliver_2000 --arch_g audio_to_pose_gans --arch_d D_patchgan --speaker oliver --output_path /home/zb/GitHub/MyModel/LearningIndividualStylesOfConversationalGesture --train_csv ../train_oliver.csv --epochs 2000
```
